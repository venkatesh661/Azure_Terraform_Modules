...
variable "aof_backup_enabled" {
  description = "Enable or disable AOF persistence for this Redis Cache (Premium only)"
  type        = bool
  default     = false
}

variable "aof_storage_connection_string_0" {
  description = "First Storage Account connection string for AOF persistence (Premium only)"
  type        = string
  default     = null
  sensitive   = true
}
...
variable "aof_storage_connection_string_1" {
  description = "Second Storage Account connection string for AOF persistence (Premium only)"
  type        = string
  default     = null
  sensitive   = true
}
